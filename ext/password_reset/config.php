...
final class PasswordResetSuccessEmailConfig extends MailTemplateConfigGroup
{
    public const KEY = "password_reset";
    public ?string $title = "Password Reset Success Email";

    public function get_template_prefix(): string
    {
        return "password_reset_success_email";
    }

    public function get_default_subject(): string
    {
        return "Your Pudimbooru password reset is complete";
    }
