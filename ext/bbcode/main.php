    ...
    public function onHelpPageBuilding(HelpPageBuildingEvent $event): void
    {
        if ($event->key === "formatting") {
            $event->add_section(
                "BBCode",
                emptyHTML(
                    "Tags de formatação básicas:",
                    UL(
                        LI(CODE("[b]", B("negrito"), "[/b]")),
                        LI(CODE("[i]", I("itálico"), "[/i]")),
                        LI(CODE("[u]", U("sublinhado"), "[/u]")),
                        LI(CODE("[s]", S("riscado"), "[/s]")),
                        LI(CODE("[sup]", SUP("sobrescrito"), "[/sup]")),
                        LI(CODE("[sub]", SUB("subscrito"), "[/sub]")),
                        LI(CODE("[h1]Título 1[/h1]")),
                        LI(CODE("[h2]Título 2[/h2]")),
                        LI(CODE("[h3]Título 3[/h3]")),
                        LI(CODE("[h4]Título 4[/h4]")),
                        LI(CODE("[align=left|center|right]Texto Alinhado[/align]")),
                    ),
                    BR(),
                    "Link tags:",
                    UL(
                        ...
                        LI(CODE("[url=site://help/formatting]Link a ajuda do BBCode[/url]")),
                        LI(CODE("[email]webmaster@shishnet.org[/email]")),
                        LI(CODE("[[artigo da wiki]]")),
                        LI(CODE("[[artigo da wiki|com algum texto alternativo]]")),
                        LI(CODE(">>123 (link ao post #123)")),
                        LI(CODE("[anchor=target]Role ao #bb-target[/anchor]")),
                    ),
                    BR(),
                    "Mais tags de formatação:",
                    UL(
                        LI(CODE("[list]...[/list] or [ul]...[/ul] (lista desordenada)")),
                        LI(CODE("[ol]...[/ol] (lista ordenada)")),
                        LI(CODE("[li]Item da lista[/li] or [*]Item da lista")),
                        LI(CODE("[code]print(\"Olá Mundo!\");[/code]")),
                        LI(CODE("[spoiler]Feliz Aniversário Orion[/spoiler]")),
                        LI(CODE("[quote]oi eu soghet[/quote]")),
                        LI(CODE("[quote=daisylenerd]oi eu soghet[/quote]")),
                    )
                ),
            );
        }
